...
class Species(models.Model):
    ...
    parent1 = models.ForeignKey("self", related_name="species_parent1", null=True, on_delete=models.DO_NOTHING)
    parent2 = models.ForeignKey("self", related_name="species_parent2", null=True, on_delete=models.DO_NOTHING)
